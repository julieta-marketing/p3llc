...
export function HeroProjectLink() {
  ...
  return (
    <a
      ...
      className="group relative z-30 inline-flex min-h-12 cursor-pointer items-center gap-3 rounded-full px-2 font-sans text-[0.8rem] font-semibold uppercase tracking-[0.14em] text-white/76 outline-none transition-colors hover:text-[color:var(--color-azure)] focus-visible:ring-2 focus-visible:ring-[color:var(--color-azure)]"
    >
      Case Studies
