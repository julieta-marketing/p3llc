...
export default function ContactPage() {
  return (
    <div className="flex min-h-screen flex-col">
      <SiteHeader />
      <main id="main" className="bg-[#050a0d]">
        <section className="relative isolate overflow-hidden bg-[#050a0d] pb-24 pt-36 text-white md:pb-32 md:pt-44 lg:pb-36">
          <div className="pointer-events-none absolute inset-0 bg-[#06141a]" aria-hidden="true" />
          ...
          <Container className="relative z-10">
            ...
            <div className="mt-16 grid grid-cols-1 overflow-hidden rounded-[1.4rem] border border-white/12 bg-[#090e12]/82 shadow-[0_36px_100px_rgba(0,0,0,0.42)] backdrop-blur-xl lg:mt-24 lg:grid-cols-12">
        ...
        <section
          id="faq"
          className="scroll-mt-24 border-t border-white/8 bg-[#070c0f] py-20 text-white md:py-28 lg:py-32"
        >
          <Container>
