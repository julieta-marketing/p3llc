          ...
          <header className="bg-[color:var(--surface-2)] pb-12 pt-32 md:pb-16 md:pt-40">
            <Container>
              <Reveal>
                ...
                <div className="mt-10 max-w-[74rem]">
                  <div className="flex flex-wrap items-center gap-x-3 gap-y-2 font-['Poppins'] text-[0.78rem] font-semibold uppercase tracking-[0.12em] text-[color:var(--color-blue)]">
                  ...
                  <h1 className="mt-7 max-w-[22ch] text-balance font-sans text-[2.25rem] font-medium leading-[1.03] tracking-[-0.05em] text-[color:var(--color-navy)] sm:text-[3.45rem] sm:leading-[1.01] lg:text-[4rem]">
                    {post.title}
                  </h1>
                  <p className="mt-7 max-w-[68ch] text-[1.05rem] leading-8 text-muted-foreground md:text-[1.15rem]">
                    {post.introduction}
                  </p>
                </div>
              </Reveal>
          ...
          <section className="bg-[color:var(--surface-2)]">
            <Container className="pb-16 md:pb-24">
              <Reveal variant="image">
                ...
                {post.imageCredit ? (
                  <p className="mt-4 text-right text-[0.8rem] leading-6 text-muted-foreground">
                    Image source:{' '}
                    {post.imageCreditUrl ? (
                      <a
              ...
              <div className="grid grid-cols-1 gap-12 lg:grid-cols-12 lg:gap-10">
                <Reveal as="aside" className="lg:col-span-3">
                  <div className="border-t border-[color:var(--color-navy)]/15 pt-5 lg:sticky lg:top-28">
                    <Eyebrow>About This Repost</Eyebrow>
                    <p className="mt-5 text-[0.98rem] leading-7 text-muted-foreground">
                    ...
                    {post.content.map((block, index) =>
                      block.type === 'heading' ? (
                        ...
                        >
                          ...
                          <footer className="mt-5 font-['Poppins'] text-[0.78rem] font-semibold uppercase tracking-[0.14em] text-[color:var(--color-blue)]">
                            {block.attribution}
                          </footer>
                        </blockquote>
                      ) : (
            ...
            <Reveal className="flex flex-col gap-8 md:flex-row md:items-end md:justify-between">
              <div>
                ...
                <p className="mt-4 text-base leading-7 text-muted-foreground">
                  Read more P3 news, project lessons, and perspectives.
                </p>
              </div>
              <CtaLink href="/news" variant="dark" size="lg" arrow>
                View All News
              </CtaLink>
            </Reveal>
          </Container>
